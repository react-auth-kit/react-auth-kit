...
const Login = () => {
  ...
  const loginHandler = () => {
    ...
    signIn({
      auth: {
        token: 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiZXhwIjoxNzExODcxNzQwfQ.gckANDZphIVZmS4fgF4pIfOSIWrcXni3OurX7KHJBiE'
      },
